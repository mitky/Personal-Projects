 ...
 * 
 */
@WebServiceClient(name = "Server", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/CodingExcercise2/Server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVER_QNAME = new QName("http://server/", "Server");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CodingExcercise2/Server?wsdl");
